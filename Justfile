...
# run tests
test:
	pytest --cov-report xml --cov-report html --cov=simularium_metrics_calculator simularium_metrics_calculator/tests
...
generate-docs:
	rm -f docs/simularium_metrics_calculator*.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs simularium_metrics_calculator **/tests
